package com.lechneralexander.privatebrowser.preference;
...
public class PreferenceManager {
    ...
    public boolean getFinishOnPause() {
        return mPrefs.getBoolean(Name.FINISH_ON_PAUSE, false);
    }
    ...
    public void setFinishOnPause(boolean enable) {
        putBoolean(Name.FINISH_ON_PAUSE, enable);
    }
